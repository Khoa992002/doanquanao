            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('admin/profile')}}" aria-expanded="false">
                        ...
                        <span class="hide-menu">Thông tin của admin</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('admin/quanlisanpham')}}" aria-expanded="false">
                        <i class="mdi mdi-cube"></i>
                        <span class="hide-menu">Quản lí sản phẩm</span>
                    </a>
                </li>
                 <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('admin/quanlinhanhang')}}" aria-expanded="false">
                        <i class="mdi mdi-tag-outline"></i>
                        <span class="hide-menu">Danh Sách Nhãn Hàng</span>
                    </a>
                </li>

                
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/quanlinguoidung')}}"  aria-expanded="false">
                        <i class="mdi mdi-account"></i>
                        <span class="hide-menu">Quản Lí Người Dùng</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('admin/quanlidonhang')}}" aria-expanded="false">
                 ...
                 <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('admin/blog')}}" aria-expanded="false">
                       <i class="mdi mdi-pencil"></i>
                        <span class="hide-menu">Quản Lí Blog</span>
                    </a>
                </li>
